...
showlength=()=>{
    document.getElementById('length_box').style.visibility="visible";
    document.getElementById('area_box').style.visibility="hidden";
    document.getElementById('time_box').style.visibility="hidden";
    document.getElementById('volume_box').style.visibility="hidden";
    document.getElementById('temperature_box').style.visibility="hidden";
    document.getElementById('weight_box').style.visibility="hidden";
}
showarea=()=>{
    document.getElementById('length_box').style.visibility="hidden";
    document.getElementById('area_box').style.visibility="visible";
    document.getElementById('time_box').style.visibility="hidden";
    document.getElementById('volume_box').style.visibility="hidden";
    document.getElementById('temperature_box').style.visibility="hidden";
    document.getElementById('weight_box').style.visibility="hidden";
...
showtime=()=>{
    document.getElementById('time_box').style.visibility="visible";
    document.getElementById('length_box').style.visibility="hidden";
    document.getElementById('area_box').style.visibility="hidden";
    document.getElementById('volume_box').style.visibility="hidden";
    document.getElementById('temperature_box').style.visibility="hidden";
...
showvolume=()=>{
    ...
    document.getElementById('area_box').style.visibility="hidden";
    document.getElementById('time_box').style.visibility="hidden";
    document.getElementById('volume_box').style.visibility="visible";
    document.getElementById('temperature_box').style.visibility="hidden";
    document.getElementById('weight_box').style.visibility="hidden";
}
...
showtemperature=()=>{
    ...
    document.getElementById('time_box').style.visibility="hidden";
    document.getElementById('volume_box').style.visibility="hidden";
    document.getElementById('temperature_box').style.visibility="visible";
    document.getElementById('weight_box').style.visibility="hidden";
}
showweight=()=>{
    document.getElementById('length_box').style.visibility="hidden";
    ...
    document.getElementById('volume_box').style.visibility="hidden";
    document.getElementById('temperature_box').style.visibility="hidden";
    document.getElementById('weight_box').style.visibility="visible";
}
